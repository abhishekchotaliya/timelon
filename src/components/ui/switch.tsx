...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        // Use the background color so the thumb contrasts against both the
        // (foreground-colored) checked track and the gray unchecked track in
        // either theme — a plain white thumb vanished on the white dark-mode track.
